        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview menu-open">
                    <a href="/thbook/seller/dashboard" class="nav-link active">
                ...
                <li class="nav-item">
                    <a href="/thbook/seller/product-manager" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="/thbook/seller/order-manager" class="nav-link">
