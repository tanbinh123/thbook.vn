                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <button class="btn btn-primary"><a style="color: white" href="add-product">Thêm sản phẩm</a></button>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="products" items="${products}" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="/thbook/admin/deleteProduct" method="POST">
                                                            <input type="hidden" id="custId" name="id" value="${products.id}">
